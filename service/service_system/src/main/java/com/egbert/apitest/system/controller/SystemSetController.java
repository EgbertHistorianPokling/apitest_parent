...
public class SystemSetController {
    ...
    @GetMapping("findAll")
    public List<SystemSet> findAllSystemSet() {
        //调用service的方法
    ...
    public Result findPageHospSet(@PathVariable long current,
                                  ...
                                  @RequestBody(required = false) com.atguigu.yygh.vo.hosp.HospitalSetQueryVo hospitalSetQueryVo) {
